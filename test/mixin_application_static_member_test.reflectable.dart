  ...
  const prefix0.Reflector(): new r.ReflectorData(
      <m.TypeMirror>[
        new r.NonGenericClassMirrorImpl(
            r"M",
            r"test_reflectable.test.mixin_application_static_member_test.M",
            7,
            0,
        ...
        new r.NonGenericClassMirrorImpl(
            r"A",
            r"test_reflectable.test.mixin_application_static_member_test.A",
            7,
            1,
            const prefix0.Reflector(),
            const <int>[7, 8],
        ...
        new r.NonGenericClassMirrorImpl(
            r"B",
            r"test_reflectable.test.mixin_application_static_member_test.B",
            7,
            2,
            const prefix0.Reflector(),
            const <int>[9],
            ...
            null),
        new r.NonGenericClassMirrorImpl(
            r"test_reflectable.test.mixin_application_static_member_test.A with test_reflectable.test.mixin_application_static_member_test.M",
            r"test_reflectable.test.mixin_application_static_member_test.test_reflectable.test.mixin_application_static_member_test.A with test_reflectable.test.mixin_application_static_member_test.M",
            583,
            3,
            const prefix0.Reflector(),
            const <int>[],
      ...
      <m.LibraryMirror>[
        new r.LibraryMirrorImpl(
            r"test_reflectable.test.mixin_application_static_member_test",
            Uri.parse(
                r"reflectable://0/test_reflectable.test.mixin_application_static_member_test"),
            const prefix0.Reflector(),
            const <int>[],
            {},
            {},
