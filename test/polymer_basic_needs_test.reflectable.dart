  ...
  const prefix0.MyReflectable(): new r.ReflectorData(
      <m.TypeMirror>[
        new r.NonGenericClassMirrorImpl(
            r"A",
            r"test_reflectable.test.polymer_basic_needs_test.A",
            7,
            0,
      ...
      <m.DeclarationMirror>[
        new r.VariableMirrorImpl(
            r"i", 32773, 0, const prefix0.MyReflectable(), -1, -1, -1, null),
      ...
      <m.ParameterMirror>[
        new r.ParameterMirrorImpl(r"i", 32774, 2, const prefix0.MyReflectable(),
